...
class Migration(DataMigration):
    def forwards(self, orm):
        ...
        unactivated_users = orm.User.objects.filter(is_active=False).all()
        ...
        activated_users = orm.User.objects.filter(is_active=True).exclude(profile__activationKey='').all()
